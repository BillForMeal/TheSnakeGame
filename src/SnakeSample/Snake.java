...
/**
 * The class that encapsulates the star of the show. Basically it stores it's
 * current state and stuff like position, velocity, length and so on and so
 * forth.
 *
...
public class Snake {
    ...
    /**
     * The constructor the snake. It takes the initial point, for the head and
     * the Grid that it lives (and dies) in.
     *
    ...
    /**
     * This method is called after food has been consumed. It increases the
     * length of the snake by one.
     *
     * @param point The Point where the food was and the new location for the
     * head.
     */
    ...
    /**
     * Called during every update. It gets rid of the oldest point and adds the
     * given point.
     *
